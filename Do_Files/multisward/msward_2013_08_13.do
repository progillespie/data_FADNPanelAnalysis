...
local 	model1command 	"sfpanel `dep_vlist' `indep_vlist' `location_vlist' i.countrycode2 year, model(bc95) cost d(tnormal) emean(`z_vlist', noconstant)  usigma(`z_vlist', noconstant) vsigma(`z_vlist', noconstant) marginal(`z_vlist')" 

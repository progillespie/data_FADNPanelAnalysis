...
*local 	lnx_vlist	"`lnx_vlist' lnmachininerybuildingscurrentcosts"
...
local 	z_vlist		"`z_vlist' lnfdratio"
...
replace fdratio = 100*(feedforgrazinglivestockhomegrown/feedforgrazinglivestock)
...
sfpanel `dep_vlist' `indep_vlist' TREND if country=="DEU", model(bc95) d(tnormal) emean(`z_vlist')
estimates store bc95_DEU

sfpanel `dep_vlist' `indep_vlist' TREND if country=="FRA", model(bc95) d(tnormal) emean(`z_vlist')
estimates store bc95_FRA
sfpanel `dep_vlist' `indep_vlist' TREND if country=="IRE", model(bc95) d(tnormal) emean(`z_vlist')
estimates store bc95_IRE
sfpanel `dep_vlist' `indep_vlist' TREND if country=="UKI", model(bc95) d(tnormal) emean(`z_vlist') 
estimates store bc95_UKI

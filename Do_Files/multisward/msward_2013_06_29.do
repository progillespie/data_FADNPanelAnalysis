...
* Tasks
*    - ensure portability - run from another drive
*                                                [DONE]
*
*    - NOTE: code generating _lu is hardcoded. if working
* 	on a sector other than dairy it will be wrong
*    - NOTE: also, no auto gen of _kg in it
*    - 
*    - 
*    - 
*------------------------------------------------------

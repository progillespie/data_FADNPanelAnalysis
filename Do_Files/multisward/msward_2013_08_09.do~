...
local 	indep_vlist 	"lndotomkgl " // measure of output (physical quantity)
* CALCULATED FROM FADN VARIABLES
local 	indep_vlist 	"`indep_vlist' lnPLand" 
local 	indep_vlist 	"`indep_vlist' lnPTotalCattle" 
local 	indep_vlist 	"`indep_vlist' lnPLabour"  
* EUROSTAT PRICE INDICES
	* FEED
*local 	indep_vlist 	"`indep_vlist' lnPCompoundfeedingstuffsforcalv"
local 	indep_vlist 	"`indep_vlist' lnPCompoundfeedingstuffsforcatt"
local 	indep_vlist 	"`indep_vlist' lnPCerealsandmillingbyproducts"
*local 	indep_vlist 	"`indep_vlist' lnPOilcakes"
	* FERTILISER
*local 	indep_vlist 	"`indep_vlist' lnPOtherfertilizerssoilimprovers"
local 	indep_vlist 	"`indep_vlist' lnPFERTILISERSANDSOILIMPROVERS"

	* ANY REMAINING COSTS
*local 	indep_vlist 	"`indep_vlist' lnPElectricity" 
local 	indep_vlist 	"`indep_vlist' lnPMotorfuels" 
local 	indep_vlist 	"`indep_vlist' lnPVETERINARYEXPENSES"
local 	indep_vlist 	"`indep_vlist' lnPSEEDSANDPLANTINGSTOCK"
*local 	indep_vlist 	"`indep_vlist' lnPMACHINERYANDOTHEREQUIPMENT"
local 	indep_vlist 	"`indep_vlist' lnPMAINTENANCEOFBUILDINGS"
*local 	indep_vlist 	"`indep_vlist' lnPOTHERGOODSANDSERVICES"
*local 	indep_vlist 	"`indep_vlist' ln"
...
predict v, u // predict uses u instead of residuals for idiosyncratic error in xtreg context

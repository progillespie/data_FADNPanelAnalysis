...
local 	dep_vlist 	"lntotalspecificcosts" 

*local 	dep_vlist 	"lntotalinputsndx" // using an input index doesn't seem to work
...
local 	z_vlist		"lnfdratio `location_vlist'" // 
...
* Unit variables
*-----------------
* create list of vars to put into based on dep_vlist
...
*local lnhomog_w: list lnhomog_w - dep_vlist

...
/* NOTE: The country or region dummies must exist in the data. If
	 ...
	 of the code. 						*/ 
local 	location_vlist 	"`location_vlist' azone2"
local 	location_vlist 	"`location_vlist' azone3"
...
local 	dep_vlist 	"`lnq_vlist'" // using an input index doesn't seem to work
...
* MODEL COMMANDS HERE
* ===================
sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if country == "DEU", model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')  vsigma(`z_vlist')  
estimates store `model1name'_DEU_tech

sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if country == "FRA", model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist') vsigma(`z_vlist')
estimates store `model1name'_FRA_tech
 
sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if country == "IRE", model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')  
estimates store `model1name'_IRE_tech

sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if country == "UKI", model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')
estimates store `model1name'_UKI_tech

sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if atl_plains == 1, model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')  vsigma(`z_vlist')
estimates store `model1name'_ATL_tech

sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND if cont_eur == 1, model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')  vsigma(`z_vlist')
estimates store `model1name'_CEU_tech

sfpanel `dep_vlist' `indep_vlist' `location_vlist' TREND, model(bc95) d(tnormal)  emean(`z_vlist')  usigma(`z_vlist')  vsigma(`z_vlist')

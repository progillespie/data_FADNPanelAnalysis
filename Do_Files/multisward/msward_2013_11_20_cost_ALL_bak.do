...
* turn on logs 
log using logs/$project$datestamp.txt, replace text
...
sfpanel `dep_vlist' `indep_vlist' TREND if country == "DEU", `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') vsigma(`z_vlist')
estimates store `model1name'_DEU_`tech_or_cost'

*qui reg `dep_vlist' `indep_vlist' TREND if country == "FRA"
sfpanel `dep_vlist' `indep_vlist' TREND if country == "FRA", `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') usigma(`z_vlist') vsigma(`z_vlist') 
estimates store `model1name'_FRA_`tech_or_cost'

*qui reg `dep_vlist' `indep_vlist' TREND if country == "IRE"
sfpanel `dep_vlist' `indep_vlist' TREND if country == "IRE", `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') usigma(`z_vlist') vsigma(`z_vlist') 
estimates store `model1name'_IRE_`tech_or_cost'

*qui reg `dep_vlist' `indep_vlist' TREND if country == "UKI"
sfpanel `dep_vlist' `indep_vlist' TREND if country == "UKI", `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') usigma(`z_vlist') vsigma(`z_vlist') 
estimates store `model1name'_UKI_`tech_or_cost'

*qui reg `dep_vlist' `indep_vlist' TREND if atl_plains == 1
sfpanel `dep_vlist' `indep_vlist' TREND if atl_plains == 1,  `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') usigma(`z_vlist') vsigma(`z_vlist') 
estimates store `model1name'_ATL_`tech_or_cost'

*qui reg `dep_vlist' `indep_vlist' TREND if cont_eur == 1
sfpanel `dep_vlist' `indep_vlist' TREND if cont_eur == 1,    `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist') usigma(`z_vlist') vsigma(`z_vlist') 
estimates store `model1name'_CEU_`tech_or_cost'
*/
*qui reg `dep_vlist' `indep_vlist' TREND
sfpanel `dep_vlist' `indep_vlist' TREND ,   		     `cost' model(bc95) d(tnormal) posthessian robust emean(`z_vlist', noconstant) vsigma(`z_vlist') 

...
* Tasks
*    - run yesterday's msward through fadn_igm.dta
*
*
*    - 
*------------------------------------------------------
...
if $databuild == 1{
	...
	* grass proxy
	...
	/*use C:\\Users\\03113752\\Data\\data_FADNPanelAnalysis\\OutData\\FADN_IGM\\fadn_igm.dta, clear
	qui do sub_do/renameFADN.do
	qui do sub_do/model_setup.do

	rename COUNTRY2 France
	rename COUNTRY3 Ireland
	rename COUNTRY4 UnitedKingdom

	rename GREGION1 Bretagne 
	rename GREGION2 NormandieHaute
	rename GREGION3 NormandieBasse 
	rename GREGION4 Wales 
	rename GREGION5 Irelandtoo  
	rename GREGION6 Bayern
	rename GREGION7 OtherRegions */
}

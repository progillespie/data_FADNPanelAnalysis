...
local dodir "D:\Data\Data_FADNPanelAnalysis\Do_Files\IGM"
...
* NOTE: The exchange rate adjustment is not constant in the most recent version. 
...
tabstat cex_wages if country=="IRE" [weight=wt], by(year)
tabstat cex_wages if country=="UKI" [weight=wt], by(year)
...
if `BMWonly'==0 {
	...
	* daforare Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_daforare_ROI.wmf, replace
	...
	* GO Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_fdairygo_ha_ROI.wmf, replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* Cost Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_cost_ha_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_ha1_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* lu_ha Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_lu_ha_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* GO Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_fdairygo_lu_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* Cost Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_cost_lu_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_lu1_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* lt_lu Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_lt_lu_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* GO Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_fdairygo_lt_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* Cost Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_cost_lt_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_lt1_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* labu_ha Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_labu_ha_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* GO Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_fdairygo_labu_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* Cost Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_cost_labu_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_labu1_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_labu_adj_ROI.wmf , replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_labu1_land_ROI.wmf, replace
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_nm_labu_adj_land_ROI.wmf, replace  
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI
	...
	graph export `outdatadir'/densities/kden_rentrateha_ROI.wmf, replace  
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	...
	* NM Kernel Density ROI- NI 
	...
	graph export `outdatadir'/densities/kden_ownlandval_ROI.wmf, replace  
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
...
* ROI vs. NI
	* NM Kernel Density ROI- NI (adjusted milk price)
	kdensity nm_labu_adj_land if cntry == 1  & year == 2008 & nm_lt1  < 0.3  & nm_lt1  > -0.1, plot(kdensity nm_labu_adj_land if cntry == 2 & year == 2008 & nm_lt1  < 0.3 & nm_lt1  > -0.1) legend(label(2 "NI") label(1 "ROI") rows(1)) scheme(s2color)
	graph export `outdatadir'/densities/kden_nm_labu_adj_land_ROI.wmf, replace  
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	ksmirnov nm_labu_adj_land if year == 2008 & nm_lt1  < 0.3  & nm_lt1  > -0.1, by(cntry) 
	...
	* NM Kernel Density ROI- NI (all exchange rate adjusted)
	kdensity cex_nm_labu_land if cntry == 1  & year == 2008 & nm_lt1  < 0.3  & nm_lt1  > -0.1, plot(kdensity nm_labu_adj_land if cntry == 2 & year == 2008 & nm_lt1  < 0.3 & nm_lt1  > -0.1) legend(label(2 "NI") label(1 "ROI") rows(1)) scheme(s2color)
	graph export `outdatadir'/densities/kden_nm_labu_cex_land_ROI.wmf, replace  
	* select all farms in 2008 (SE, BMW, NI), compare by country (ROI = SE + BMW to  NI)
	ksmirnov nm_labu_adj_land if year == 2008 & nm_lt1  < 0.3  & nm_lt1  > -0.1, by(cntry) 

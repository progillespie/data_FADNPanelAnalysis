...
---- BACK ON --------------------*/
	...
	*---------------------------------
	* Using nm_labu_adj_econcost
	*---------------------------------
	capture drop nm_labu_adj_econcost
	gen nm_labu_adj_econcost = (fdairygo_adj - fdairydc - fdairyoh - unpaidfamilyfactors)/labourinputhours
	local var "nm_labu_adj_econcost"
	matrix KS_`var' = (0, 0)
	matrix TT_`var' = (0, 0)
	local i = 0
	foreach yr of local yr_list{
...
foreach var of varlist nm_labu1  nm_labu_adj  nm_labu1_land  nm_labu_adj_land nm_labu_adj_econcost {
	matrix list KS_`var'
	matrix list TT_`var'
	
}

*do sub_do/FADNvalidate.do
